...
// Provider
// const privatekeys = ["98d88baf868ed7f5b65e37753ef58b33119447ef56f1adc6b73127bd2bcaa219"];
// const privatekeys = ["cc44f51a3935aa1d5c2f7b1cfc2b3d4903e57402413d1cb506a35a264bb8009f"];
const privatekeys = [];
networks = {
    local: {
...
switch (networkName) {
    case 'local':
        provider = new HDWalletProvider(privatekeys, networks[networkName].url);
